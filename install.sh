#!/usr/bin/env sh
# Universal installer for ratecheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ratecheck.git"
echo "Installing ratecheck ..."
