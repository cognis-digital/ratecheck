"""RATECHECK core — Probe API rate-limit/abuse resistance from a request spec."""
...
RULES = [
    ("RAT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("RAT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("RAT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
