...
import argparse, sys
from ratecheck.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="ratecheck", description="RATECHECK — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from ratecheck.mcp_server import serve
        return serve()
    if args.cmd == "scan":
